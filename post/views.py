...
def index(request):
	...
	url = 'http://api.openweathermap.org/data/2.5/weather?q={}&units=imperial&appid=9e30582bceae8710e9a7c6360d339f0e'
	city = 'Seoul'
	...
	weather = {
        'city' : city,
        'temperature' : round((city_weather["main"]["temp"] - 32) * 5 / 9, 0),
